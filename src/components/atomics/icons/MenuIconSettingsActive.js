...
const SVG = ({
  ...
  viewBox="0 0 12 12"
    ...
    <svg id="Menu_Icon_Thiet_lap_Active" data-name="Menu/Icon/Thiet lap/Active" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
    <defs>
