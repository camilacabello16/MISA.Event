...
const SVG = ({
  ...
  viewBox="0 0 12 12"
    ...
    <svg id="Menu_Icon_Thiet_lap_Default" data-name="Menu/Icon/Thiet lap/Default" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
    <g id="Setting" transform="translate(2.5 2)">
      ...
      <path id="Path-2" data-name="Path" d="M2.9,5.65A2.853,2.853,0,0,1,0,2.83,2.861,2.861,0,0,1,2.9,0a2.825,2.825,0,1,1,0,5.65" transform="translate(6.61 7.18)" fill="#fff"/>
    </g>
